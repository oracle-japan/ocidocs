...
## Autonomous JSON Database(AJD)からAutonomous Transaction Processing(ATP)への変更はできますか？ (New. 2022/02)
...
## ストレージ容量以上のデータを格納しようとした場合はどうなりますか？ (New. 2022/02)
...
## バックアップは開始時点でスナップショットが取得されるのでしょうか？その場合、バックアップの完了を待たずともDDL/DML/起動停止等の操作は可能ですか。 (New. 2022/02) 
...
## Data Pump を利用した論理バックアップはできますか？ (New. 2022/02)
...
## セッションの瞬断対策として何か講じることはできますか？ (New. 2022/02)
...
## Autonomous Database とOracle Database 以外のデータベースの連携は可能ですか？ (New. 2022/02)
...
## 行や列単位でアクセス制御をかけることはできますか？ (New. 2022/02)
...
## 一部の重たいクエリによるリソースの大量消費を防ぐ仕組みはありますか？ (New. 2022/02)
