---
title: "Autonomous Database Cloud 技術詳細"  # タイトル
excerpt: "Oracle Databaseを利用したフルマネージド・データベース・サービスである、Autonomous Databaseについて、特徴や、利用方法などについてカバーしています"
...
Oracle Databaseを利用したフルマネージド・データベース・サービスである、Autonomous Databaseについての概要解説資料です。  
...
<script async class="speakerdeck-embed" data-id="e534dd66f48847a69305eb40743691ef" data-ratio="1.77777777777778" src="//speakerdeck.com/assets/embed.js"></script>
